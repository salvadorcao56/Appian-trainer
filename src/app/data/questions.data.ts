  ...
  },
  {
    ...
    respuestas: [
      ...
      },
      {
        ...
        correcta: false,
        explicacion: 'INCORRECTO: Seleccionar ASynchronously hace que el proceso padre NO espere a que el proceso hijo termine.'
      },
      {
        id: 116,
        contenido: 'Navigate to the Setup tab and select Synchronously.',
        correcta: true,
        explicacion: 'CORRECTO: En la pestaña Setup, seleccionar Synchronously hace que el proceso padre espere a que el proceso hijo termine.'
      },
      {
        id: 117,
